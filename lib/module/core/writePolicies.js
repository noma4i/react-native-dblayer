...
const isIncomingNewerBy = (path, incoming, previous) => isIncomingNewer(scalarFieldCodecs.date.read(readPath(previous, path)), scalarFieldCodecs.date.read(readPath(incoming, path)));
