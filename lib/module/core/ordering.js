...
export const isMultiFieldSort = sort => Array.isArray(sort);
 ...
 */
export const pickLowestRow = (rows, comparator) => {
...
export const canonicalOrderOptions = direction => ({
  direction,
  nulls: 'last',
  stringSort: 'lexical'
});
...
export const sortModelReadRows = (rows, orderBy, limit) => limitRows([...rows].sort(createFieldOrderComparator(orderBy)), limit);
