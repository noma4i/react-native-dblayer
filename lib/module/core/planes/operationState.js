...
const isPersistedOperationState = value => isNonArrayRecord(value) && Number.isSafeInteger(value.recordVersion) && isOperationRecordMap(value.operations) && Array.isArray(value.committedKeys) && value.committedKeys.every(isNonEmptyString);
