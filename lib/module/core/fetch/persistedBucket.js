...
import { getDbQueryClient } from "../../dsl/configure.js";
import { readPersistedQuery, removePersistedQuery, writePersistedQuery } from "../queryPersistence.js";
 ...
 */
export const restorePersistedBucket = args => {
  const persisted = readPersistedQuery(args.declaration, args.identity, args.validate);
 ...
 */
export const persistBucket = args => {
