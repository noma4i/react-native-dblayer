...
import { attachRowRelated, buildRelatedAccessors, getCascadeController, registerCascadeController, relationValues, touchBelongsToParents } from "./relations.js";
...
const buildFetchScope = filter => {
  ...
  if (!normalized) return {
    scope: ROOT_FETCH_SCOPE
  };
  return {
    scope: stableSerialize(normalized),
    filter: normalized
  };
};
