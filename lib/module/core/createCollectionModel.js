...
import { createRowVersionCore } from "./rowVersionCore.js";
...
import { invalidateModel } from "./queryClient.js";
...
export function createCollectionModel(config) {
  ...
  const writePropagation = createWritePropagation(config.name);
  ...
  const versionCore = createRowVersionCore();
  let resetMergeState = () => {};
