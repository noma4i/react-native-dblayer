...
import { compositeKey, compositeStorageKey, stableSerialize } from "./serialize.js";
...
const isStoredRow = value => isRecord(value) && typeof value.id === 'string';
const isTombstoneRecord = value => isRecord(value) && Object.values(value).every(tombstone => isRecord(tombstone) && typeof tombstone.at === 'number');
