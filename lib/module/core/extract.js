...
export const getDbExtractSink = () => currentDbExtractSink.get();
...
export const getDbMutationExtractResolver = () => currentDbMutationExtractResolver.get();
 ...
 */
export const liftExtractNodes = value => {
