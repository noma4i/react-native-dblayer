...
export const resetSubscriptionRuntimeEffects = () => {
  namedEffects.clear();
};
 ...
 */
export const defineDbSubscriptionEntry = entry => entry;
...
export const createDbSubscriptionRuntime = entries => {
  ...
  const isCurrentGeneration = () => activeGeneration == null || activeGeneration === getRuntimeGeneration();
