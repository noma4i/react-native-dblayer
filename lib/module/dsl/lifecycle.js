...
import { resetRuntime } from "../core/reset.js";
import { runBootValidations } from "./bootValidations.js";
import { configureDb, flushPersistence, isDbConfigured, purgeForeignStorageKeys, replayJournal } from "./configure.js";
 ...
 */
export const bootDb = async options => {
  const {
    wipe,
    ...config
  } = options;
