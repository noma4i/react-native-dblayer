...
import { createModelReadEngine, incrementalSignature, sortModelReadRows, useIncrementalRead } from "../read/incrementalReadEngine.js";
...
export const sortRowsBySpec = (rows, sort) => 'comparator' in sort ? [...rows].sort(sort.comparator) : sortModelReadRows(rows, [{
