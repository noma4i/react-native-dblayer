...
const statesEqual = (left, right) => left.pending === right.pending && left.failed === right.failed && left.deliveryUnknown === right.deliveryUnknown && (left.unsyncedChanges === right.unsyncedChanges || left.unsyncedChanges !== undefined && right.unsyncedChanges !== undefined && rowsShallowEqual(left.unsyncedChanges, right.unsyncedChanges));
