...
export const isMethodOptimistic = value => 'method' in value;
export const isRespondOptimistic = value => 'respond' in value;
export const validateMutationConfig = config => {
