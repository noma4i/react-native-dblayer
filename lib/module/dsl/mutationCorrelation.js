...
export const registerMutationCorrelator = (modelId, correlate) => {
...
export const modelHasCorrelators = modelId => (correlators.get(modelId)?.length ?? 0) > 0;
...
export const closeCorrelatedOperation = operation => {
