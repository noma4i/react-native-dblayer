...
import { isFetchNetworkOnline } from "../core/fetch/networkState.js";
...
import { createApplyRuntime, createCommitEnvelope, getApplyTarget } from "../core/apply/transaction.js";
  ...
  queryClient = new QueryClient({
    defaultOptions: {
      queries: {
        ...
        retry: (failureCount, error) => getRuntimeGeneration() === generation && isFetchNetworkOnline() && retryDelayMs(getDbRuntimeConfig().defaults.retry?.query ?? {}, error, failureCount + 1) !== null,
