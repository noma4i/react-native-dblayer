...
import { getDbRuntimeConfig, getRuntimeGeneration } from './configure.js';
  ...
  useEffect(() => {
    ...
    const subscription = AppState.addEventListener('change', state => {
      ...
      if (state === 'active' && (previousState === 'background' || previousState === 'inactive')) {
        ...
        const isCurrent = () => resumeDrainGeneration.current === drainGeneration && getRuntimeGeneration() === runtimeGeneration;
