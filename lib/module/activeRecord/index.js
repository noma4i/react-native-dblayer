 ...
 */
export const query = (model, filter) => new ModelRelationImpl(model, filter);
 ...
 */
export const instance = (model, id) => createInstance(model, model.get(id));
 ...
 */
export const useInstance = (model, id) => createInstance(model, model.find(id));
