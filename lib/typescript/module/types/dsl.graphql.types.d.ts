...
import type { GraphqlActionDurableDefinition, GraphqlActionDurableOptions, GraphqlActionPollDefinition, GraphqlActionPollOptions, GraphqlActionRequestDefinition, GraphqlActionRequestOptions, GraphqlConnectionDefinition, GraphqlConnectionNode, GraphqlConnectionOptions, GraphqlListDefinition, GraphqlListOptions, GraphqlLiveDefinition, GraphqlLiveOptions, GraphqlSingleDefinition, GraphqlSingleOptions, TypedDocumentData, TypedDocumentVariables } from './dsl.modelFacade.types';
export type GraphqlDsl<TOwnerKey extends string = string, TBuildInput = unknown, TStored extends {
    ...
    action<TData, TVariables, TInput>(document: TypedDocumentNode<TData, TVariables>, options: GraphqlActionPollOptions<TData, TVariables, TInput, TOwnerKey, TBuildInput, TStored>): GraphqlActionPollDefinition<TData, TVariables, TInput, TOwnerKey, TBuildInput, TStored>;
