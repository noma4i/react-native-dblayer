...
export type OperationState = {
    begin(operation: Omit<OperationRecord, 'status'>, options?: {
        persist?: boolean;
    }): void;
    ...
    close(operationId: string, status: Exclude<OperationStatus, 'pending'>, options?: {
        persist?: boolean;
    }): void;
    ...
    remove(operationId: string, options?: {
        persist?: boolean;
    }): void;
