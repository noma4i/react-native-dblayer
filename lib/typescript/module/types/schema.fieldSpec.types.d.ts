...
export type SparseModelField = ModelFieldSpecs[string] & {
    [K in FieldSpecModule['fieldSpecSparseRead']]: (value: unknown, fieldKey: string) => unknown;
};
export {};
//# sourceMappingURL=schema.fieldSpec.types.d.ts.map