...
export type DurableActionTransportInput<TDefinition> = TDefinition extends GraphqlActionDurableDefinition<any, any, any, any, infer TInput, any, any, any> ? TInput : never;
export type ActionRequestDefinition<TDefinition, TStored extends {
    id: string;
}> = GraphqlActionRequestDefinition<ActionDefinitionData<TDefinition>, any, ActionInput<TDefinition>, keyof ActionDefinitionData<TDefinition> & string, string, unknown, TStored, boolean>;
...
//# sourceMappingURL=dsl.actionRuntime.types.d.ts.map