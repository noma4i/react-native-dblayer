...
export declare const createReadBuilder: <TStored extends {
    id: string;
}>(where: DbWhere<TStored> | null, terminals: ReadBuilderTerminals<TStored>, orders?: ReadonlyArray<ReadOrder<TStored>>, count?: number | undefined, required?: readonly string[]) => ModelReadBuilder<TStored>;
export {};
