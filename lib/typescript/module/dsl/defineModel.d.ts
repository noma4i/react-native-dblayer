import type { InferBuildInput, InferStoredFields, ModelFieldSpecs, ModelConfig, ModelCore, QueryScopeReads, RequiredReadUse, ScopeHandle } from '../types';
/**
 ...
 */
export declare const defineModel: <const TFields extends ModelFieldSpecs, TScopeNames extends string = never, TExt extends Record<string, unknown> = {}, TQueryScopeNames extends string = never>(config: ModelConfig<TFields, TScopeNames, TExt, TQueryScopeNames>) => Omit<ModelCore<InferStoredFields<TFields>, InferBuildInput<TFields>>, "use" | "scopes"> & {
