 ...
 * });
 */
export declare const useDbMutation: <TData, TInput, TContext = void, TStored = unknown, TServerNode = unknown, TExtractSpec = unknown>(config: DbMutationConfig<TData, TInput, TContext, TStored, TServerNode, TExtractSpec>) => import("@tanstack/react-query").UseMutationResult<TData | null, Error, TInput, unknown>;
