...
export { createNestedObjectPatcher, createIdArrayPatcher, createKeyedArrayPatcher, createThrottledSingleFlight, pruneExpiredRows, pruneOrphanedRows, reconcileOptimisticRows, resolveStaleTempRows, singletonStatics, trimRowsPerScope } from './utils/runtimePrimitives';
