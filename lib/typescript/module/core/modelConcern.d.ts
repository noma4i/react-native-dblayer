 ...
 */
export declare const defineModelConcern: <TModel, TExtension extends object>(name: string, extend: (model: TModel) => TExtension) => ModelConcern<TModel, TExtension>;
//# sourceMappingURL=modelConcern.d.ts.map