...
export declare function createModelCollection(modelId: string): Collection<StoredRowShape, string, import("@tanstack/db").UtilsRecord, never, StoredRowShape> & import("@tanstack/db").NonSingleResult;
...
export declare function ensureMembershipCollection(modelId: string): Collection<MembershipRow, string, import("@tanstack/db").UtilsRecord, import("@standard-schema/spec").StandardSchemaV1<unknown, unknown>, MembershipRow>;
...
export declare function membershipWriterFor(modelId: string): CollectionWriter;
...
export declare function collectionFor(modelId: string): Collection<any, string, import("@tanstack/db").UtilsRecord, import("@standard-schema/spec").StandardSchemaV1<unknown, unknown>, any>;
/** Returns the registered membership collection for a model identifier. */
export declare function membershipCollectionFor(modelId: string): Collection<MembershipRow, string>;
