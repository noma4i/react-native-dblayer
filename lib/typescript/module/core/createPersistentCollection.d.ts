import type { CollectionModel, CreateCollectionModelFieldsConfig, CreateCollectionModelNormalizeConfig, FieldsCollectionModel, ModelBuildStoredInput, ModelFieldSpecs, ModelFieldsInput, ModelRelationsConfig, ModelStoredFromFields, PersistentCollection, RelatedSurface, RowRelatedSurface, StoredWriteInput } from '../types';
/**
