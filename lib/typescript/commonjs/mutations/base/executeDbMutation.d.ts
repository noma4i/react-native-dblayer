 ...
 */
export declare const executeDbMutationRequest: <TData, TInput, TContext, TStored>(config: DbMutationConfig<TData, TInput, TContext, TStored>, mappedInput: unknown) => Promise<TData | null>;
/**
 ...
 * @returns void
 */
export declare const applyDbMutationCommit: <TData, TInput, TContext, TStored>(config: DbMutationConfig<TData, TInput, TContext, TStored>, result: TData | null, input: TInput, context: TContext) => void;
/**
 ...
 * @returns Mutation result field or null.
 */
export declare const runDbMutationDirect: <TData, TInput, TContext = void, TStored = unknown>(config: DbMutationConfig<TData, TInput, TContext, TStored>, input: TInput, context?: TContext) => Promise<TData | null>;
