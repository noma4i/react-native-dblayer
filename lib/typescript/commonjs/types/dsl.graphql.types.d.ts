...
import type { ActionMode, GraphqlActionDefinition, GraphqlActionOptions, GraphqlConnectionDefinition, GraphqlConnectionNode, GraphqlConnectionOptions, GraphqlListDefinition, GraphqlListOptions, GraphqlLiveDefinition, GraphqlLiveOptions, GraphqlSingleDefinition, GraphqlSingleOptions, TypedDocumentData, TypedDocumentVariables } from './dsl.modelFacade.types';
type ActionOptionsForMode<TData, TVariables, TInput, TResultKey extends keyof TData & string, TNode, TMode extends ActionMode> = Extract<GraphqlActionOptions<TData, TVariables, TInput, TResultKey, TNode>, TMode extends 'request' ? {
    mode?: 'request';
} : {
    mode: TMode;
}>;
type ActionModeMarker<TMode extends ActionMode> = TMode extends 'request' ? {
    mode?: 'request';
} : {
    mode: TMode;
};
export type GraphqlDsl = {
    ...
    action<TDocument extends TypedDocumentNode<any, any>, TInput, TResultKey extends keyof TypedDocumentData<TDocument> & string, TNode, TMode extends ActionMode = 'request'>(document: TDocument, options: ActionOptionsForMode<TypedDocumentData<TDocument>, TypedDocumentVariables<TDocument>, TInput, TResultKey, TNode, TMode> & ActionModeMarker<TMode>): GraphqlActionDefinition<TypedDocumentData<TDocument>, TypedDocumentVariables<TDocument>, TInput, TResultKey, TNode> & ActionModeMarker<TMode>;
};
export {};
