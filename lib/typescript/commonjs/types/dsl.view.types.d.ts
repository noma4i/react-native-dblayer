...
export type InternalViewConfig<TItem> = {
    ...
    select?: (row: RowRecord, included: ViewIncluded, ctx: {
        index: number;
    }) => TItem;
    renderKeys?: readonly string[];
...
//# sourceMappingURL=dsl.view.types.d.ts.map