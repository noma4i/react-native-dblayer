...
type ModelMutationConfig<
  ...
  TNode
> = Omit<MutationConfig<TData, TInput, TStored, TNode>, 'dedupe'> & {
...
type CrudQueryHandle = ReturnType<
  typeof defineQuery<
    unknown,
    unknown,
    unknown,
  ...
  >
>;
type CrudCreateHandle = ReturnType<
  typeof defineMutation<
    unknown,
    unknown,
    {
      id: string;
  ...
  >
>;
type CrudIdMutationHandle = ReturnType<
  typeof defineMutation<
    unknown,
    {
      id: string;
...
> = {
   ...
   */
  crud<TSections extends CrudSections>(
    sections: TSections
  ): {
...
type RequiredReadUse<
  TStored extends {
    id: string;
    updatedAt?: string | null;
  },
  TKey extends keyof TStored & string
> = Omit<ModelCore<TStored>['use'], 'row' | 'first'> & {
  row<TProjection extends Record<string, unknown>>(
    id: string | null | undefined,
    opts: {
      select: (row: TStored) => TProjection;
