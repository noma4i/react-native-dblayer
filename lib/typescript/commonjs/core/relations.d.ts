 ...
 */
export declare const belongsTo: <TChild, TParent>(
 ...
 */
export declare const hasMany: <TParent, TChild>(
 ...
 */
export declare const hasOne: <TParent, TChild>(
  model: ModelRef<TChild>,
  options: {
    foreignKey: keyof TChild & string;
 ...
 */
export declare const references: <TChild, TRef>(
  model: ModelRef<TRef>,
  options: {
