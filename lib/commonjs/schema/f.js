...
const valueField = (kind, readValue, readNullableValue = (0, _fieldSpec.preserveNull)(readValue)) => (0, _fieldSpec.createFieldSpec)({
  kind,
  mode: 'required',
...
const f = exports.f = {
   ...
   */
  str: () => valueField('str', _normalizeHelpers.readString, _normalizeHelpers.readNullableString),
  /**
   ...
   */
  num: () => valueField('num', _normalizeHelpers.readNumber, _normalizeHelpers.readNullableNumber),
  /**
   ...
   */
  date: () => valueField('date', _normalizeHelpers.readIsoDate),
  /**
   ...
   */
  bool: () => valueField('bool', _normalizeHelpers.readBoolean),
  /**
   ...
   */
  id: () => valueField('id', _normalizeHelpers.readId),
  /**
  ...
  enum: values => {
    ...
    return valueField('enum', value => typeof value === 'string' && allowed.has(value) ? value : undefined);
  },
  /**
