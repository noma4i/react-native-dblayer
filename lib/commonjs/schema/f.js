...
const valueField = (kind, readValue) => (0, _fieldSpec.createFieldSpec)({
  kind,
  mode: 'required',
  selectSource: _fieldSpec.readObjectField,
  codec: (0, _fieldCodec.defineFieldCodec)(readValue),
  defaultNull: false
});
const customField = (kind, readValue) => (0, _fieldSpec.createFieldSpec)({
  kind,
  mode: 'required',
...
const f = exports.f = {
   ...
   */
  str: () => valueField('str', _fieldCodec.scalarFieldCodecs.str.read),
  /**
   ...
   */
  num: () => valueField('num', _fieldCodec.scalarFieldCodecs.num.read),
  /**
   ...
   */
  int: () => valueField('int', _fieldCodec.scalarFieldCodecs.int.read),
  /**
   ...
   */
  date: () => valueField('date', _fieldCodec.scalarFieldCodecs.date.read),
  /**
   ...
   */
  bool: () => valueField('bool', _fieldCodec.scalarFieldCodecs.bool.read),
  /**
   ...
   */
  id: () => valueField('id', _fieldCodec.scalarFieldCodecs.id.read),
  /**
   ...
   */
  enum: values => {
    return valueField('enum', (0, _fieldCodec.createEnumFieldCodec)(values).read);
  },
  /**
