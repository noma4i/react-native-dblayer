...
const mergeInitialSyncContract = ({
  ...
  scope,
  protectAfterSeq
}) => (0, _serverSync.mergeSyncContract)(pageParam === undefined ? 'initial' : 'loadMore', scope, protectAfterSeq);
...
const replaceInitialSyncContract = ({
  ...
  scope,
  protectAfterSeq
}) => pageParam === undefined ? (0, _serverSync.replaceSyncContract)('initial', scope, protectAfterSeq) : (0, _serverSync.mergeSyncContract)('loadMore', scope, protectAfterSeq);
exports.replaceInitialSyncContract = replaceInitialSyncContract;
const applySingleSync = (selected, sync, protectAfterSeq) => {
  ...
  sync.model.applyServerData(selectedItems, (0, _serverSync.mergeSyncContract)(sync.contract, undefined, protectAfterSeq));
};
