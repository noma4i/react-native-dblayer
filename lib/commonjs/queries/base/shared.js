...
exports.pickEqual = exports.buildStableItems = void 0;
exports.useStableEntity = useStableEntity;
exports.useStableProjection = useStableProjection;
 ...
 */
function useStableProjection(sources, config) {
  ...
  return (0, _react.useMemo)(() => {
    ...
    if (previousItems && (0, _useLiveRead.arraysShallowEqual)(previousItems, nextItems)) {
...
const useStableSorted = (source, compare, invalidationKey) => {
  ...
  return (0, _react.useMemo)(() => {
    ...
    if (previous && Object.is(previous.invalidationKey, invalidationKey) && (0, _useLiveRead.arraysShallowEqual)(previous.source, source)) {
