...
exports.trimRowsPerScope = exports.resolveStaleTempRows = exports.reconcileOptimisticRows = exports.createThrottledSingleFlight = exports.createSingletonStatics = exports.createNestedObjectPatcher = exports.createKeyedArrayPatcher = exports.createIdArrayPatcher = exports.createGenerationFence = void 0;
 ...
 */
const createSingletonStatics = (model, recordId, defaults) => {
  const upsert = input => {
  ...
  return {
    ...
    useCurrentField: field => model.use.field(recordId, field) ?? defaults[field],
...
exports.createSingletonStatics = createSingletonStatics;
