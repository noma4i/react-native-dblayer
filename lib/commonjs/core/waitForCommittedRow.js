...
exports.waitForCommittedRow = void 0;
...
const waitForCommittedRow = (model, id, options) => {
  ...
  return new Promise(resolve => {
    ...
    subscription = (0, _configure.getCommitBus)().subscribe(() => {
...
exports.waitForCommittedRow = waitForCommittedRow;
