...
const currentDbExtractSink = (0, _configuredSlot.createConfiguredSlot)(defaultDbExtractSink);
const currentDbMutationExtractResolver = (0, _configuredSlot.createConfiguredSlot)(defaultDbMutationExtractResolver);
...
const getDbExtractSink = () => currentDbExtractSink.get();
...
const getDbMutationExtractResolver = () => currentDbMutationExtractResolver.get();
...
const createMutationExtractResolver = presetTable => (extractSpec, result) => {
  if (!(0, _normalizeHelpers.isRecord)(extractSpec)) return undefined;
