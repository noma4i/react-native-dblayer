...
const isIncomingNewer = (existingUpdatedAt, incomingUpdatedAt) => {
  const existingMs = existingUpdatedAt ? (0, _normalizeHelpers.toTimestamp)(existingUpdatedAt) : Number.NaN;
  const incomingMs = incomingUpdatedAt ? (0, _normalizeHelpers.toTimestamp)(incomingUpdatedAt) : Number.NaN;
