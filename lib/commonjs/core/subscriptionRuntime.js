...
exports.defineDbSubscriptionEntry = exports.createDbSubscriptionRuntime = exports.createDbSubscriptionEffects = void 0;
...
const createDbSubscriptionRuntime = entries => {
  ...
  const isCurrentGeneration = () => activeGeneration == null || activeGeneration === (0, _configure.getRuntimeGeneration)();
  ...
  return {
    setActive(nextActive) {
      ...
      active = true;
      activeGeneration = (0, _configure.getRuntimeGeneration)();
      for (const state of states) {
        subscribeEntry(state);
      }
    },
