...
const checkpointEpoch = (storage, prefix) => {
  ...
  if (!raw) return 0;
  const parsed = (0, _persistenceCodec.decodeSupportedPersistence)(raw, _persistenceCodec.PERSISTENCE_SCHEMA_VERSION, value => typeof value === 'object' && value !== null && typeof value.lastCheckpointEpoch === 'number');
