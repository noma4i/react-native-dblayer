...
exports.keysForSequence = exports.keyBetween = exports.keyBefore = exports.keyAfter = exports.isOrderKey = void 0;
/**
...
const isOrderKey = value => typeof value === 'string' && /^[0-9A-Za-z]*[1-9A-Za-z]$/.test(value);
 ...
 */
exports.isOrderKey = isOrderKey;
const keyBetween = (lower, upper) => {
  let prefix = '';
...
exports.keyBetween = keyBetween;
const keyBefore = key => keyBetween(undefined, key);

/** Generate a key strictly after `key` (an append placement). */
exports.keyBefore = keyBefore;
const keyAfter = key => keyBetween(key, undefined);
exports.keyAfter = keyAfter;
const paddedValue = (key, length) => {
  let value = 0;
 ...
 */
const keysForSequence = (count, lower, upper) => {
  if (count <= 0) return [];
...
exports.keysForSequence = keysForSequence;
