...
const DB_FORMAT_VERSION = exports.DB_FORMAT_VERSION = 11;
...
(0, _reset.registerCurrentManifestEntryProvider)(() => ({
  key: manifestKey((0, _configure.getStoragePrefix)()),
  value: (0, _persistenceCodec.encodePersistence)(currentPersistenceManifest())
}));
