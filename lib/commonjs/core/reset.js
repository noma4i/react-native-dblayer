...
const isStorageResetIntent = value => (0, _normalizeHelpers.isNonArrayRecord)(value) && value.recordVersion === STORAGE_RESET_INTENT_VERSION && Array.isArray(value.restore) && value.restore.every(entry => (0, _normalizeHelpers.isNonArrayRecord)(entry) && typeof entry.key === 'string' && typeof entry.value === 'string');
const readStorageResetIntent = () => {
  ...
  return (0, _persistenceCodec.decodeSupportedPersistence)(raw, _persistenceCodec.PERSISTENCE_SCHEMA_VERSION, isStorageResetIntent) ?? {
