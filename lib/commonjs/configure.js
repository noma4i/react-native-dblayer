...
const configureDb = options => {
  ...
  (0, _queryClient.setDbQueryClient)(options.queryClient);
  (0, _tracking.setDbTrackSink)(options.trackSink);
  ...
  (0, _freshnessStorage.pruneStaleFetchStates)(_freshnessStorage.DEFAULT_FETCH_STATE_MAX_AGE_MS);
};
