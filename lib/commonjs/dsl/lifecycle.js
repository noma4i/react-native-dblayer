...
const bootDb = async () => {
  ...
  const assertCurrentGeneration = () => {
    if ((0, _configure.getRuntimeGeneration)() !== generation) throw new Error('runtime generation changed during boot');
  };
  let rejectReset;
  ...
  try {
    ...
    (0, _store.hydrateStoreScopes)((0, _transaction.getApplyTargets)());
