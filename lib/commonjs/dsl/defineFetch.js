...
const defineFetch = config => {
  ...
  const use = input => {
    ...
    const loadingState = (0, _react.useMemo)(() => (0, _loadingState.computeLoadingState)(phase, phaseInput), [phase, phaseInput.hasData, phaseInput.isFetching, phaseInput.isPaused, phaseInput.retryAttempt]);
