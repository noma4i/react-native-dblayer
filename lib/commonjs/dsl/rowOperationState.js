...
const statesEqual = (left, right) => left.pending === right.pending && left.failed === right.failed && (left.unsyncedChanges === right.unsyncedChanges || left.unsyncedChanges !== undefined && right.unsyncedChanges !== undefined && (0, _useLiveRead.rowsShallowEqual)(left.unsyncedChanges, right.unsyncedChanges));
