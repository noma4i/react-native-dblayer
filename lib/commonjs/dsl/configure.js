...
exports.resetPersistenceRuntime = exports.replayJournal = exports.purgeForeignStorageKeys = exports.noteMaintenancePersistence = exports.isDbConfigured = exports.hasReplayedJournal = exports.getStoragePrefix = exports.getRuntimeGeneration = exports.getOperationState = exports.getInternalQueryClient = exports.getDbRuntimeConfig = exports.getCommitBus = exports.getApplyRuntime = exports.flushPersistence = exports.configureDb = exports.cancelPersistence = exports.advanceRuntimeGeneration = void 0;
...
const replayJournal = () => {
  ...
  for (const operation of orphaned) {
    if (operation.tempIds.length > 0 && hasApplyTarget(operation.model)) {
      runtime.apply((0, _relations.expandPlan)([{
        kind: 'destroy',
  ...
  for (const [model, ids] of candidates) {
    ...
    if (orphanIds.length > 0 && hasApplyTarget(model)) runtime.apply((0, _relations.expandPlan)([{
      kind: 'destroy',
      model,
      ids: orphanIds,
      tombstone: false
