...
exports.resetPersistenceRuntime = exports.replayJournal = exports.purgeForeignStorageKeys = exports.noteMaintenancePersistence = exports.isDbConfigured = exports.hasReplayedJournal = exports.getStoragePrefix = exports.getRuntimeGeneration = exports.getPersistenceDataVersion = exports.getOperationState = exports.getInternalQueryClient = exports.getDbRuntimeConfig = exports.getCommitBus = exports.getApplyRuntime = exports.flushPersistence = exports.configureDb = exports.advanceRuntimeGeneration = void 0;
...
const replayJournal = () => {
  ...
  for (const [model, ids] of candidates) {
    ...
    if (orphanIds.length > 0 && hasApplyTarget(model)) runtime.apply([{
      kind: 'destroy',
      model,
      ids: orphanIds,
      tombstone: false
