...
exports.runPendingTempRowMaintenance = exports.runModelMaintenance = exports.registerModelMaintenance = exports.isTempRowProtectedByModel = void 0;
var _generationRegistry = require("../core/generationRegistry.js");
const runners = (0, _generationRegistry.createGenerationRegistry)();
 ...
 * @returns Nothing.
 */
const registerModelMaintenance = (modelId, runner) => {
...
const runModelMaintenance = () => [...runners.values()].flatMap(runner => runner.boot());
...
const runPendingTempRowMaintenance = () => [...runners.values()].flatMap(runner => runner.pendingTempRows());

/** Return the current model-declared protection set used by every unresolved-temp cleanup path. */
exports.runPendingTempRowMaintenance = runPendingTempRowMaintenance;
const isTempRowProtectedByModel = (modelId, id) => runners.get(modelId)?.protectedTempIds().has(id) ?? false;
exports.isTempRowProtectedByModel = isTempRowProtectedByModel;
