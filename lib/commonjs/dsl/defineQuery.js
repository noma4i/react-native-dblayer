...
exports.sinkIf = exports.defineQuery = void 0;
 ...
 */
const sinkIf = (into, row) => row == null ? [] : [{
  into,
  rows: [row]
}];
exports.sinkIf = sinkIf;
...
const defineQuery = config => {
  ...
  const issuedResetSeqByScope = new Map();
  const appliedResetSeqByScope = new Map();
  (0, _reset.registerReset)(() => {
