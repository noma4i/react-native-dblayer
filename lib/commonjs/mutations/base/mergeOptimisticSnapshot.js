...
exports.resolveMergedField = exports.mergeOptimisticSnapshot = void 0;
...
exports.resolveMergedField = resolveMergedField;
...
const mergeOptimisticSnapshot = (optimistic, server, options) => {
  if (!options?.fields) {
...
exports.mergeOptimisticSnapshot = mergeOptimisticSnapshot;
