 ...
 * the row survived but left the destination scope (complete-coverage snapshot, retention trim, GC
 * membership detach). Both reach the reader as a touched scope - `applyExecution` records the
