...
/**
 * `src/dsl/defineModel.ts` still imports `trimRowsPerScope` from this path.
 * Owned by `modelMaintenance.ts`; this line is temporary until that consumer's import is updated.
 */
export { trimRowsPerScope } from './modelMaintenance';
