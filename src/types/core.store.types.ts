...
export type PreparedUpsert<T> = { row: T; changedFields: string[] | null };
...
export type EntityState<T extends { id: string }> = {
  ...
  previewUpsert(row: T, options: { previous: T | undefined; mergeBase?: T; ctx?: WriteCtx }): PreparedUpsert<T>;
