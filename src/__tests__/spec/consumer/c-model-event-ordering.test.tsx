...
import { acquireModelSubscriptions, advanceRuntimeGeneration, getCommitBus, registerModelEvent } from '../../testApi';
...
describe('model event ordering', () => {
  ...
  it('does not deliver after a commit storage failure', () => {
    const document = makeDocument();
