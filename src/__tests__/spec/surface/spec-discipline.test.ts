...
const internalAccessExceptions: ReadonlyArray<{ spec: string; source: string }> = [
  ...
  { spec: path.resolve(specRoot, 'integrity/i-apply-recovery.test.ts'), source: path.resolve(specRoot, '../../core/apply/transaction.ts') },
  ...
  { spec: path.resolve(specRoot, 'integrity/i-commit-envelope-planning.test.tsx'), source: path.resolve(specRoot, '../../core/apply/transaction.ts') },
  ...
  { spec: path.resolve(specRoot, 'perf/p05-pending-index-scale.test.tsx'), source: path.resolve(specRoot, '../../core/apply/transaction.ts') },
