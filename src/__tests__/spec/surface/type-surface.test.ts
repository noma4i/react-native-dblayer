...
defineDbSubscriptionEntry: <TDocument extends TypedDocumentNode<unknown, never>, TKey extends Extract<keyof ResultOf<TDocument>, string>>(entry: TypedDbSubscriptionEntry<TDocument, TKey>) => import("/Users/noma4i/yupi/react-native-dblayer/src/core/subscriptionRuntime").DbSubscriptionEntry<unknown>
