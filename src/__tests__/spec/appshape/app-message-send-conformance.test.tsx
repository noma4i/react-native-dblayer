...
const insertChat = (models: ReturnType<typeof createAppModels>) => {
  ...
  models.chats.insert({ id: 'chat-1', uuid: null, kind: 'personal', status: 'active', premium: false, name: null, logoUrl: null, description: null, isPublic: false, history: 'all', pinned: false, muted: false, read: false, unreadCount: 0, messagesCount: 0, lastActivityAt: time, lastMessageAt: null, lastSequenceNumber: null, lastMessage: null, readMarksSummary: null, summary: null, connectionStatus: null, userIds: [], owner: null, createdAt: time, updatedAt: time });
};

const message = (id: string, overrides: Record<string, unknown> = {}) => ({ id, chatId: 'chat-1', userId: ownId, body: 'hello', kind: 'text', status: 'Sending', createdAt: time, updatedAt: time, sequenceNumber: 1, mediaGroupId: null, replyToId: null, media: null, mediaBucket: null, localPreviewUrl: null, clientId: id, ...overrides });
