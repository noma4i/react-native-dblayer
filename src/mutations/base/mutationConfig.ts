...
export const resolveMutationKey = <TData, TInput, TContext, TStored, TServerNode>(config: DbMutationConfig<TData, TInput, TContext, TStored, TServerNode>): readonly unknown[] =>
  config.key ? config.key() : [config.resultField];

export const resolveMutationLogPrefix = <TData, TInput, TContext, TStored, TServerNode>(config: DbMutationConfig<TData, TInput, TContext, TStored, TServerNode>): string =>
